...
<div class="container">
  <div class="row">
    <div class="form_main">
      ...
      <div class="form">
      <form onsubmit="return checkform()" method="POST" action="UpdateEmpController" id="contactFrm" name="contactFrm" >
          <input type="hidden" name="headrole" value="<%=request.getParameter("headrole") %>" >
          <label for="fname">ID</label> 
          <input id="fname" class="form-control" type="text" name="ID" maxlength="10" value="<%=request.getAttribute("id")%>">
